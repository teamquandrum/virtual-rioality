...
import com.quandrum.atos.ARManager;
import com.quandrum.atos.AugmentedLayout;
import com.quandrum.atos.CameraViewer;
import com.quandrum.atos.LatLonCalculator;
import com.quandrum.atos.R;
import com.quandrum.atos.SizeManager;
...
public class AugmentedRealityActivity extends Activity implements SensorEventListener, OnClickListener{
	...
	public void updateUI()// TODO Optimisations - DONE
	{
		Log.d("mAugLayoutSize","At updateUI: "+mAugLayoutList.size());
		mAlCtr=0;

		Log.d("UpdateUI","Intent should hve been called");
		if(mArManager==null)
		{
			try{
